...
public class TreasureFactory {
	...
	private static TreasureFactory instance = new TreasureFactory();
	...
	public Treasure createTreasure() {
		...
		int treasureNo = generator.nextInt(4);
		int loreNo = generator.nextInt(2);


		return new Treasure(names[treasureNo], lore[loreNo]);
	}
}
